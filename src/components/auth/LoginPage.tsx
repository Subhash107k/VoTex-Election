...
import { Lock, Mail, Vote, ArrowLeft, ShieldCheck, Sun, Moon } from "lucide-react";
        ...
        <div className={`w-full max-w-md p-6 sm:p-8 rounded-3xl border ${bgCard} relative`}>
          ...
          <div className="mb-6 text-center sm:text-left">
            ...
            <p className={`text-xs ${textMuted} mt-1`}>
              Enter your registered email address or username to access your voter portal.
            </p>
          </div>
          ...
          <form onSubmit={handleLoginSubmit} className="flex flex-col gap-4 text-xs font-sans">
            ...
            <div className="mt-4 pt-4 border-t border-slate-200/80 dark:border-slate-800 text-center">
              <p className={`text-xs ${textMuted}`}>
                Election Official or Admin?{" "}
                <button
                  type="button"
