...
export const CandidateDashboard: React.FC<CandidateDashboardProps> = ({
  ...
  const errors = {
    name:
      touched.name && !isNameValid ? "Full candidate name is required." : "",
    party:
      touched.party && !isPartyValid
        ? "Political party affiliation is required."
        : "",
    electionId:
      touched.electionId && !isElectionValid
        ? "Please select a target active election."
        : "",
    photoUrl:
      touched.photoUrl && !isPhotoValid
        ? "Candidate digital headshot is required."
        : "",
    manifestoText:
      touched.manifestoText && !isManifestoValid
        ? "Civic focus manifesto description is required."
        : "",
  };
  ...
  return (
    <div className="flex-1 bg-slate-950 text-slate-150 p-4 sm:p-6 md:p-8 space-y-8 font-sans">
      ...
      <AnimatePresence>
        {toast && (
          <div
            className={`fixed top-6 right-6 z-50 px-5 py-3 rounded-xl shadow-2xl flex items-center gap-2 animate-bounce border ${
              toast.isError
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-3xl shadow-xl">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400 max-w-xl">
            Register and update your campaign profile details, upload credential
            headers, select target contests, and audit status.
          </p>
        </div>
        ...
        {isVerified ? (
          <div className="bg-emerald-950/20 border border-emerald-850/80 p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Your campaign portfolio has been successfully reviewed,
                optimized, and verified by federal election observers. All
                details are now locked to prevent ballot tampering. Visitors can
                view your records, campaign history, and vote.
              </p>
            </div>
          </div>
          ...
          <div className="bg-red-950/20 border border-red-850/80 p-5 rounded-2xl flex flex-col sm:flex-row items-start gap-4">
            ...
            <div className="space-y-1.5 flex-1">
              ...
              <div className="p-3 bg-slate-950 border border-red-950 rounded-xl">
                <span className="block text-[10px] text-red-450 uppercase font-bold tracking-wider mb-0.5">
                  Observer Comments:
                </span>
                <p className="text-xs font-mono text-slate-300 leading-normal">
                  {profile.rejectionReason ||
                    "Please verify credentials and manifestos for accuracy and typos."}
                </p>
              </div>
              <p className="text-[11px] text-slate-500 max-w-2xl leading-normal">
                You can correct the highlighted details in the edit terminal
                below and resubmit. Our security agents will re-evaluate within
                24 hours.
              </p>
            </div>
          </div>
          ...
          <div className="bg-amber-950/20 border border-amber-850/80 p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Your dossier has been registered and is currently waiting for
                secure administrative certification. Profile fields can still be
                edited if needed — editing will re-queue the submission to the
                first position of audit tasks.
              </p>
            </div>
          </div>
        ) : (
          <div className="bg-blue-950/25 border border-blue-900/60 p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4 animate-pulse">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Get started by creating your official candidate profile. Once
                certified, your digital card can be selected by thousands of
                voters.
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl relative overflow-hidden">
            <div className="flex items-center gap-2 mb-6 border-b border-slate-800 pb-3">
              ...
              <h3 className="font-extrabold text-sm text-white uppercase tracking-wider">
                Candidate Dossier Credentials Form
              </h3>
            </div>
            ...
            {isVerified ? (
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-indigo-400 font-mono tracking-tight flex items-center gap-1 mt-0.5">
                        <User className="w-3.5 h-3.5" /> Approved Candidate
                    ...
                    <div className="flex flex-wrap gap-3 text-xs">
                      <div className="flex items-center gap-1.5 bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-xl text-slate-300">
                        ...
                        <span className="font-bold">
                          Party: {formData.party || "Independent"}
                        </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-850/60">
                    ...
                    <p className="text-xs text-slate-300 leading-normal font-sans">
                      {formData.education || "No education history declared."}
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-850/60">
                    ...
                    <p className="text-xs text-slate-300 leading-normal font-sans">
                      {formData.experience ||
                        "No professional overview declared."}
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-850/60">
                    ...
                    <p className="text-xs text-slate-300 leading-normal font-sans">
                      {formData.biography ||
                        "No personal bio statement declared."}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-900 border border-slate-800 rounded-2xl text-[11px] text-slate-400 flex gap-2 leading-relaxed">
                  ...
                  <p>
                    All of the candidate profile values above are locked under
                    federal cryptographic hashing mechanisms. If you suspect any
                    informational discrepancy, please consult your assigned
              ...
              <form
                onSubmit={handleSave}
                className="space-y-6 text-slate-300 text-xs font-sans"
              >
                ...
                <div>
                  ...
                  >
                    <option value="" disabled>
                      -- Select political party from registry --
                    </option>
                    {parties.map((py) => (
                    ...
                    <option value="Independent">
                      Independent (No Group Affiliation)
                    </option>
                  </select>
                  <p className="text-[10px] text-slate-500 mt-1">
                    Political party options listed above are managed dynamically
                    under the federal administrative register panel.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-slate-400 font-bold uppercase text-[10px] tracking-wide">
                    ...
                    {errors.photoUrl && (
                      <span className="text-[9px] text-red-500 font-semibold font-mono">
                        {errors.photoUrl}
                      </span>
                    )}
                  </div>
                    ...
                    {formData.photoUrl ? (
                      ...
                      >
                        ...
                        <div className="text-left space-y-1">
                          ...
                          <p
                            className="text-[9px] text-slate-500 truncate max-w-[200px]"
                            title={formData.photoUrl}
                          >
                            Source:{" "}
                      ...
                      <>
                        ...
                        <div>
                          <p className="font-bold text-slate-200 text-[11px]">
                            Click or Drag & Drop headshot photo file
                          </p>
                          <p className="text-[9px] text-slate-500 mt-0.5">
                            JPEG, PNG standards. Aspect ratio 1:1 works best
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <div className="mt-1">
                    <span className="text-[9px] text-slate-500 block mb-1">
                      Or paste custom image web address link manually:
                    </span>
                    <input
                      type="text"
                ...
                {!isFormValid && (
                  <div className="text-center">
                    <span className="text-[10px] text-amber-500 font-semibold flex items-center justify-center gap-1">
                      ...
                      <span>
                        Form is locked from saving until all mandatory fields
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl relative overflow-hidden group">
            ...
            <div className="bg-slate-950 rounded-2xl border border-slate-850 p-4 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-slate-500 font-medium truncate mt-0.5">
                    {parties.find(
                      (py) =>
                        py.name === formData.party ||
                        py.code === formData.party,
                    )?.name ||
                      formData.party ||
                ...
                {formData.partyLogoUrl ? (
                  <div className="flex items-center gap-1.5">
                    <img
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <span className="font-bold text-slate-300 font-mono text-[9px] uppercase">
                      {formData.party || "Logo"}
                    </span>
                  </div>
                ) : (
                  <span className="text-slate-550 italic font-mono text-[10px]">
                    No logo matched
                  </span>
                )}
              </div>
              ...
              <div className="space-y-1 pt-1">
                <span className="text-[9px] font-bold uppercase tracking-wider text-slate-500 font-mono">
                  Manifesto Core Excerpt:
                </span>
                <p className="text-[11px] text-slate-400 leading-normal line-clamp-3 italic">
                  "
                  {formData.manifestoText ||
                    "The campaign program manifesto remains unwritten. Please write your public manifesto to populate ballot sheet sheets."}
                  "
                </p>
              </div>
            ...
            <p className="text-[10px] text-slate-500 mt-3 leading-normal">
              This layout mimics the format voters encounter in our
              high-security ballot interface when casting federal elections.
            </p>
          </div>
              ...
              {profile && profile.history && profile.history.length > 0 ? (
                profile.history.map((h, i) => (
                  <div key={i} className="relative flex gap-3 text-xs">
                    {/* Bullet */}
                    <div
                      className={`absolute -left-[5px] w-2.5 h-2.5 rounded-full border-2 border-slate-900 mt-1 ${
                        h.status === "Verified"
                          ? "bg-emerald-500"
                          : h.status === "Rejected"
                            ? "bg-red-500"
                    ...
                    <div className="pl-4 space-y-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span
                          className={`font-extrabold uppercase font-mono tracking-wide text-[9px] px-1.5 py-0.2 rounded-md ${
                            h.status === "Verified"
                ...
                <div className="text-slate-500 italic py-2 text-center text-xs">
                  No historical audits have been executed on this candidate
                  document yet.
                </div>
              )}
            </div>
