          ...
          <AnimatePresence mode="wait">
            {!cameraActive && !previewImage && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="w-full max-w-md px-4 py-6 text-center sm:px-6"
              >
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-blue-500/20 bg-blue-500/10 text-blue-400 shadow-[0_0_20px_rgba(59,130,246,0.15)] sm:h-20 sm:w-20">
                  <Camera className="h-8 w-8 sm:h-9 sm:w-9" />
                </div>

                <h4 className="mb-2 text-sm font-extrabold uppercase tracking-wider text-slate-100 sm:text-base">
                  Biometric Engine Closed
                </h4>

                <p className="mx-auto mb-5 max-w-[280px] text-[11px] leading-relaxed text-slate-400 sm:max-w-sm sm:text-xs">
                ...
                <button
                  type="button"
                  onClick={startCamera}
                  className="w-full rounded-xl bg-blue-600 px-5 py-2.5 text-[10px] font-bold uppercase tracking-wider text-white shadow-lg transition-all duration-200 hover:scale-[1.01] hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 sm:w-auto sm:text-xs"
                >
                  Mount Secure Camera
                </button>
              </motion.div>
