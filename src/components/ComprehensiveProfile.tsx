...
export default function ComprehensiveProfile({
  ...
  const [activeProfileTab, setActiveProfileTab] = useState<
    "personal" | "family" | "citizenship" | "nid" | "contact"
  >("personal");
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      if (res.ok) {
        const data = await res.json();
        setSuccessMsg(
          "Your citizen profile credentials have been successfully updated!",
        );
        setIsEditing(false);
  ...
  const renderValue = (val: any) => {
    ...
    return (
      <span className="font-bold text-xs select-all text-emerald-500 font-mono">
        {val}
      </span>
    );
  };
  ...
  const renderValueText = (val: any) => {
    ...
    return (
      <span
        className={`font-semibold text-xs leading-relaxed ${isDark ? "text-slate-200" : "text-slate-800"}`}
      >
        {val}
      </span>
    );
  ...
  return (
    <div
      className={`p-1.5 rounded-3xl border transition-all duration-300 ${bgCanvas} ${isDark ? "shadow-2xl" : "shadow-md"}`}
    >
      {/* Top action header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800/50">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Theme switcher */}
          <div
            className={`flex items-center rounded-xl p-0.5 border ${isDark ? "bg-slate-950 border-slate-800" : "bg-slate-100 border-slate-200"}`}
          >
            <button
              type="button"
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 gap-3 font-mono">
          ...
          <span className="text-xs text-slate-500 tracking-wider">
            Synchronizing biometric credentials...
          </span>
        </div>
      ) : (
        <div
          className={`transition-all duration-350 p-4 md:p-6 rounded-2xl ${bgBody}`}
        >
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
              ...
              <div>
                <div className="flex items-center flex-wrap gap-2 justify-center md:justify-start">
                  <h2
                    className={`text-lg font-black tracking-tight ${textTitle}`}
                  >
                    {user.fullName}
                  </h2>
                ...
                <p className="text-xs text-slate-500 mt-0.5 font-mono">
                  State-Verified Register Block:{" "}
                  <span className="text-emerald-500 font-bold">{user.id}</span>
                </p>
            ...
            >
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-1 font-sans">
                  Adjust editable parameters below. Verified details will be
                  reviewed for blockchain audit integrity.
                </p>
              </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  {activeProfileTab === "personal" && (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className={`p-4 rounded-2xl border ${bgCard}`}>
                          <div className="flex items-center gap-2 text-slate-400 mb-1.5">
                            ...
                            <span className="text-[10px] uppercase font-mono font-bold tracking-wide">
                              English Name
                            </span>
                          </div>
                        ...
                        <div className={`p-4 rounded-2xl border ${bgCard}`}>
                          ...
                          {renderValueText(
                            profile?.bloodGroup || "Not Available",
                          )}
                        </div>
                      ...
                      <div className="space-y-4">
                        <h4
                          className={`text-xs uppercase tracking-widest font-mono font-extrabold ${isDark ? "text-slate-400" : "text-slate-500"}`}
                        >
                          ...
                          <div className={`p-4 rounded-2xl border ${bgCard}`}>
                            ...
                            >
                              {profile?.isTemporarySameAsPermanent
                                ...
                                : profile?.temporaryAddress || "Not Registered"}
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  {activeProfileTab === "family" && (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Father details */}
                        <div
                          className={`p-4 rounded-2xl border ${bgCard} space-y-3`}
                        >
                      ...
                      {isMarried ? (
                        <div className="space-y-4 pt-4 border-t border-slate-200/5 animate-in fade-in duration-300">
                          <div className="flex items-center gap-2">
                            ...
                            <h4
                              className={`text-xs uppercase tracking-widest font-mono font-extrabold ${isDark ? "text-rose-450" : "text-rose-600"}`}
                            >
                              Additional Spouse Information (Married Record
                              Verified)
                            </h4>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {/* Spouse details */}
                            <div
                              className={`p-4 rounded-2xl border ${bgCard} border-rose-500/10 space-y-3`}
                            >
                              <div className="border-b border-white/5 pb-2">
                            ...
                            >
                              ...
                              <div className="space-y-1">
                                ...
                                {renderValueText(
                                  profile?.spouseFatherNameNepali,
                                )}
                              </div>
                            </div>
                            ...
                            >
                              ...
                              <div className="space-y-1">
                                ...
                                {renderValueText(
                                  profile?.spouseMotherNameNepali,
                                )}
                              </div>
                            </div>
                          </div>
                  ...
                  {activeProfileTab === "citizenship" && (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          <div
                            className={`p-5 rounded-2xl border ${bgCard} space-y-4`}
                          >
                            ...
                            <div className="grid grid-cols-2 gap-4 text-xs">
                              ...
                              <div>
                                ...
                                {renderValueText(
                                  profile?.citizenshipType || "By Descent",
                                )}
                              </div>
                              ...
                              <div>
                                ...
                                {renderValue(
                                  profile?.citizenshipIssueDate || "2009-05-12",
                                )}
                              </div>
                              ...
                              <div>
                                ...
                                {renderValueText(
                                  profile?.citizenshipIssueDistrict ||
                                    profile?.district ||
                                    "Kathmandu",
                                )}
                              </div>
                              ...
                              <div className="col-span-2">
                                <span className="text-[9px] font-mono text-slate-500 block uppercase">
                                  Issuing High Authority
                                </span>
                                {renderValueText(
                                  profile?.citizenshipIssueAuthority ||
                          ...
                          {/* Signature block */}
                          <div
                            className={`p-4 rounded-xl border ${bgCard} flex flex-col gap-4`}
                          >
                            <div>
                              ...
                              <p className="text-[10px] text-slate-500 mt-1 max-w-[200px]">
                                Sealed cryptographic hash of custom handwritten
                                signature matched at registry.
                              </p>
                            </div>
                            {document?.signatureImage ? (
                              <div className="flex flex-col gap-3 items-center justify-center">
                                <img
                                  ...
                                  className="bg-slate-950 border border-slate-800 p-2 rounded-lg max-h-16 object-contain w-full"
                                />
                                <a
                                  href={document.signatureImage}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-full text-center px-3 py-2 bg-slate-900 border border-slate-700 text-[10px] rounded hover:bg-slate-800 font-mono font-bold text-white uppercase"
                                >
                                  Open Original Signature
                                </a>
                              </div>
                            ) : (
                              <div className="h-14 w-full bg-slate-950/50 border border-dashed border-slate-800 rounded-lg flex items-center justify-center text-slate-600 text-[10px] font-mono">
                                Not Uploaded
                              </div>
                            )}
                          </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div
                            className={`p-4 rounded-2xl border ${bgCard} flex flex-col gap-3 justify-between`}
                          >
                            <div>
                  ...
                  {activeProfileTab === "nid" && (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* ID Details Card */}
                        <div
                          className={`p-5 rounded-2xl border ${bgCard} md:col-span-1 space-y-4 flex flex-col justify-between`}
                        >
                          <div className="space-y-4">
                            <div className="flex items-center gap-2 border-b border-slate-200/5 pb-3">
                            ...
                            <div className="space-y-3.5 text-xs">
                              ...
                              <div>
                                <span className="text-[9px] font-mono text-slate-500 block uppercase">
                                  NID Issued Registry Date
                                </span>
                                {renderValue(
                                  profile?.nidIssueDate || "2019-09-22",
                                )}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl text-[11px] leading-relaxed text-indigo-300">
                            ...
                            This national database record was biometrically
                            synced from the centralized Home Ministry NID
                            registry platform.
                          </div>
                        </div>
                        ...
                        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div
                            className={`p-4 rounded-2xl border ${bgCard} flex flex-col justify-between gap-3`}
                          >
                            <div>
                  ...
                  {activeProfileTab === "contact" && (
                    ...
                    >
                      <div className="p-4 bg-amber-500/10 border border-amber-500/20 text-[11px] md:text-xs leading-relaxed text-amber-300 rounded-2xl flex items-start gap-3">
                        ...
                        <div>
                          <span className="font-bold block text-sm mb-0.5">
                            Contact Verification Security Hold
                          </span>
                          To maintain absolute defense integrity against voter
                          simulation attacks, citizen emails and mobile
                          registrations are strictly locked inside the HSM
                          vault. Contact updates require multi-factor liveness
                          approval conducted at physical Election Bureau
                          outlets.
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div
                          className={`p-5 rounded-2xl border ${bgCard} relative overflow-hidden group`}
                        >
                          ...
                          <div
                            className={`p-3 rounded-xl border font-mono text-xs text-slate-300 mt-2 flex items-center justify-between ${bgInput}`}
                          >
                            <span className="font-bold select-all leading-relaxed">
                              {user.email}
                            </span>
